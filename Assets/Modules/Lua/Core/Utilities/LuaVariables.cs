...
namespace Kultie.Lua
{
    ...
    public class LuaVariables
    {
        ...
        public static implicit operator List<Variable>(LuaVariables array)
        {
            return array.variables;
        }

        public static implicit operator LuaVariables(List<Variable> variables)
        {
            return new LuaVariables() { variables = variables };
        }
